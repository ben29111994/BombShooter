...
public class Bot : MonoBehaviour
{
    ...
    IEnumerator delayInit()
    {
        ...
        //trail.GetComponent<TrailRenderer>().startColor = botColor;
        //trail.GetComponent<TrailRenderer>().endColor = new Color32((byte)botColor.r, (byte)botColor.g, (byte)botColor.b, 0);
    }
    ...
    private void FixedUpdate()
    {
        ...
        {
            isShoot = true;
            Vector3 dirPush = aim.position - transform.position;
            spawner.SpawnBomb(aim, dirPush);
    ...
    {
        InvokeRepeating("RandomDir", delayTime, Random.Range(2, 10));
    }
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if (collision.gameObject.tag == "Wall")
        {
            ...
            StopInvoke();
            isHitWall = true;
            ChangeDir(new Vector3(Random.Range(-5, 5), 1, Random.Range(-5, 5)));
            StartInvoke(1f);
        }
    }
